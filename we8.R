...
#  actually: don't use k-means;  use a multinomial mixture instead).
#  You could do log(1+f) instead, or in absence of better guidance,
#  I just look at scaled f
